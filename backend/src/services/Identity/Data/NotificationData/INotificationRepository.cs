...
public interface INotificationRepository
{
    ...
    Task<int> GetUnreadCountAsync(Guid clientId, Guid tenantId, CancellationToken ct = default);
    Task<bool> MarkAsReadAsync(Guid notificationId, Guid tenantId, Guid? clientId = null, CancellationToken ct = default);
