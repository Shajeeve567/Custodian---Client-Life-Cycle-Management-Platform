                            ...
                            >
                                ...
                                <div className="flex items-center gap-3 shrink-0">
                                    ...
                                    <button
                                        ...
                                        className="px-3.5 py-1.5 rounded-lg bg-white hover:bg-indigo-50 border border-slate-200 hover:border-indigo-300 text-indigo-600 text-xs font-semibold transition"
                                    >
